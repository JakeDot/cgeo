...
public class Engine implements Runnable {
    ...
    public static void message (LuaTable message) {
        ...
        if (buttons != null) {
            button1 = (String)buttons.rawget(1.0);
            button2 = (String)buttons.rawget(2.0);
        }
    ...
    public static void callEvent (final EventTable subject, final String name, final Object param) {
        ...
        instance.eventRunner.perform(() -> subject.callEvent(name, param));
    }
    ...
    public static void log (String s, int level) {
        ...
        instance.log.print(now.getHour());
        instance.log.print(':');
        instance.log.print(now.getMinute());
        instance.log.print(':');
        instance.log.print(now.getSecond());
        instance.log.print('|');
