...
/**
 * "lite" flavor: only the Geocaching.com-family connectors are compiled in
 * (GC, Adventure Lab, Waymarking, the internal/user-defined connector and its
 * Travel Bug trackable support). See the "full" flavor's ConnectorFactory for
 * the full connector list (OpenCaching family, ExtremCaching, Geocaching
 * Australia, Geopeitus, TerraCaching, Geocaching.su, Geokrety).
 */
